...
app.post('/saveproduct',upload.single('file'),(req, res) => {
  let data = {product_name: req.body.product_name, product_price: req.body.product_price,qty:req.body.product_qty,product_image:imagename};
console.log(data);
...
app.post('/register',(req, res) => {
  let data = {username: req.body.username, password: req.body.password,emailid:req.body.emailid,phonr:req.body.phone,type:"customer"};
console.log(data);
